  ...
  return (
    <header>
      <Box
        ...
        paddingTop="8em"
        paddingBottom="4em"
        background="radial-gradient(circle, rgba(94,91,91,0.6587009803921569) 0%, rgba(59,56,55,1) 67%)"
      >
        <Box
          display="flex"
          flexDirection="column"
          ...
          gap="2em"
          padding="3em 0"
          sm={{ flexDirection: "row", alignItems: "flex-start" }}
          md={{ gap: "4em" }}
          lg={{ gap: "6em" }}
        >
          ...
          />
          <Box textAlign={"center"} sm={{ textAlign: "start" }}>
            {/* essa box contém o titulo da pagina */}
            <Heading
              size="4xl"
              my="10px"
              md={{ fontSize: "45px", marginBottom: "20px" }}
            >
              Pedro Henrique Brito Bastos
            </Heading>
            <Heading
              size="2xl"
              my="10px"
            ...
            <Box
              ...
              justifyContent="center"
              mt="40px"
              sm={{ justifyContent: "flex-start", flexDir: "row" }}
            >
              <Link
                href="https://www.linkedin.com/in/pedro-henrique-1b666723a/"
                display="flex"
                flexDir="column"
                sm={{ flexDir: "row" }}
              >
              ...
              <Link
                href="https://github.com/PedroBritoBastos"
                display="flex"
                flexDir="column"
                sm={{ flexDir: "row" }}
              >
